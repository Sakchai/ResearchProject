...
namespace Research.Framework.Mvc.Routing
{
    /// <summary>
    /// Represents custom overridden redirect result executor
    /// </summary>
    public class ResearchRedirectResultExecutor : RedirectResultExecutor
    {
        #region Fields
        ...
        public ResearchRedirectResultExecutor(ILoggerFactory loggerFactory, 
