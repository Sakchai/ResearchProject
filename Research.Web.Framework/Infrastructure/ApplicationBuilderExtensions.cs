...
namespace Research.Web.Framework
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseResearchExceptionHandler(this IApplicationBuilder application)
        {
            var researchConfig = EngineContext.Current.Resolve<ResearchConfig>();
            var hostingEnvironment = EngineContext.Current.Resolve<IHostingEnvironment>();
            var useDetailedExceptionPage = researchConfig.DisplayFullErrorStack || hostingEnvironment.IsDevelopment();
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseResearchResponseCompression(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseResearchStaticFiles(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseResearchAuthentication(this IApplicationBuilder application)
        {
            //check whether database is installed
            if (!DataSettingsManager.DatabaseIsInstalled)
                return;
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseResearchMvc(this IApplicationBuilder application)
        {
