...
namespace Research.Web.Framework.TagHelpers.Public
{
    ...
    public class ResearchBBCodeEditorTagHelper : TagHelper
    {
        ...
        public ResearchBBCodeEditorTagHelper(IWebHelper webHelper)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var storeLocation = string.Empty; // _webHelper.GetStoreLocation();
