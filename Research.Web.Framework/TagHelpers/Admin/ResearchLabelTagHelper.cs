...
namespace Research.Web.Framework.TagHelpers.Admin
{
    ...
    public class ResearchLabelTagHelper : TagHelper
    {
        ...
        public ResearchLabelTagHelper(IHtmlGenerator generator, IWorkContext workContext)
        {
            Generator = generator;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (tagBuilder != null)
            {
                ...
                //add hint
                //if (For.Metadata.AdditionalValues.TryGetValue("ResearchResourceDisplayNameAttribute", out object value))
                //{
                //    var resourceDisplayName = value as ResearchResourceDisplayNameAttribute;
