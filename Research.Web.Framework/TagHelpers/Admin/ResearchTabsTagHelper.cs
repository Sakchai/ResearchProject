...
namespace Research.Web.Framework.TagHelpers.Admin
{
    ...
    public class ResearchTabsTagHelper : TagHelper
    {
        ...
        public ResearchTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<ResearchTabContextItem>();
            context.Items.Add(typeof(ResearchTabsTagHelper), tabContext);
    ...
    public class ResearchTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public ResearchTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<ResearchTabContextItem>)context.Items[typeof(ResearchTabsTagHelper)];
            tabContext.Add(new ResearchTabContextItem()
            {
    ...
    /// Tab context item
    /// </summary>
    public class ResearchTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
