...
namespace Research.Infrastructure
{
    ...
    /// </summary>
    public class ResearchFileProvider : PhysicalFileProvider, IResearchFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a ResearchFileProvider
        /// </summary>
        /// <param name="hostingEnvironment">Hosting environment</param>
        public ResearchFileProvider(IHostingEnvironment hostingEnvironment) 
