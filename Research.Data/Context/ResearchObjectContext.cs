...
namespace Research.Data
{
    ...
    /// </summary>
    public partial class ResearchObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public ResearchObjectContext(DbContextOptions<ResearchObjectContext> options) : base(options)
        {
        }
