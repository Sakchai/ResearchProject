...
namespace Research.Services.Configuration
{
    ...
    public partial class SettingService : ISettingService
    {
        ...
        {
            //cache
            return _cacheManager.Get(ResearchConfigurationDefaults.SettingsAllCacheKey, () =>
            {
        ...
        public virtual void InsertSetting(Setting setting, bool clearCache = true)
        {
            ...
            //cache
            if (clearCache)
                _cacheManager.RemoveByPattern(ResearchConfigurationDefaults.SettingsPatternCacheKey);
