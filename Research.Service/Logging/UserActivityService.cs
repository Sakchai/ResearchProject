...
namespace Research.Services.Logging
{
    ...
    public class UserActivityService : IUserActivityService
    {
        ...
        {
            //cache
            return _cacheManager.Get(ResearchLoggingDefaults.ActivityTypeAllCacheKey, () =>
            {
        ...
        public virtual void InsertActivityType(ActivityLogType activityLogType)
        {
            ...
            _cacheManager.RemoveByPattern(ResearchLoggingDefaults.ActivityTypePatternCacheKey);
        }
