...
namespace Research.Services.Helpers
{
    ...
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        protected virtual BrowscapXmlHelper GetBrowscapXmlHelper()
        {
            ...
            //no database created
            if (string.IsNullOrEmpty(_researchConfig.UserAgentStringsPath))
                return null;
            ...
            lock (_locker)
            {
                ...
                var userAgentStringsPath = _fileProvider.MapPath(_researchConfig.UserAgentStringsPath);
                var crawlerOnlyUserAgentStringsPath = !string.IsNullOrEmpty(_researchConfig.CrawlerOnlyUserAgentStringsPath)
                    ? _fileProvider.MapPath(_researchConfig.CrawlerOnlyUserAgentStringsPath)
                    : string.Empty;
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            //more info: https://www.researchcommerce.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            try
            {
        ...
        public virtual bool IsMobileDevice()
        {
            ...
            try
            {
                ...
                var mobile = b.IsMatch(userAgent) || v.IsMatch(userAgent.Substring(0, 4));
                return mobile;
            }
            catch
            {
