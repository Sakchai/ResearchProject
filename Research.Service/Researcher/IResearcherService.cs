...
namespace Research.Services.Researchers
{
    public partial interface IResearcherService
    {
        ...
        IPagedList<Researcher> GetAllResearchers(int agency = 0, int personalType = 0, string firstName = null, string lastName = null, int isCompleted = 0, string email = null, int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false);
